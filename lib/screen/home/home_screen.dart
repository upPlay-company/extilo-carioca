...
import 'package:extilo_carioca/screen/servicos/categorias/categorias_screen.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => CategoriasScreen()));
                              },
                              child: Container(
                                height: 80,
                                width: 80,
